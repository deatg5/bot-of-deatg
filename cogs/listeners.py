...
#
        ...
        if random.randint(0, 100) < 10:
            ...
            if statusType == 16:
                await self.client.change_presence(status=discord.Status.online, activity=discord.Activity(type=5, name=f"{randint(1, 12)}th annual {gamePlaying} tournament"))
            if statusType == 17:
                await self.client.change_presence(status=discord.Status.idle, activity=discord.Activity(type=5, name=f"{randint(1, 12)}th annual {gamePlaying} tournament"))
            if statusType == 18:
                await self.client.change_presence(status=discord.Status.do_not_disturb, activity=discord.Activity(type=5, name=f"{randint(1, 12)}th annual {gamePlaying} tournament"))
