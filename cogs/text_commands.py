...
class TextCommands(commands.Cog):
    ...
    @commands.command(brief="sends a message generated by the GPT2 chatbot engine after i gave it my discord message history as an input. (messages were pre-generated)")
