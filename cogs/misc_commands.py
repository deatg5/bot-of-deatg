...
class MiscCommands(commands.Cog):
    ...
    @commands.slash_command(contexts={discord.InteractionContextType.private_channel, discord.InteractionContextType.guild}, integration_types={discord.IntegrationType.user_install, discord.IntegrationType.guild_install}, name="time", description="the current time according to bot of deatg")
